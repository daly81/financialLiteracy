...
function get_best_score(){
	...
	$stm = $con->prepare('
		SELECT *
		FROM quiz
		WHERE user_id = :user_id && quiz_id = 3; ; 
	');
...
<!-- CONTENT MAIN-->
	...
	<div class="container-fluid">
		<div class="row">
			<a href="../user_account/modThree.html" class="btn btn-info">Back</a>
		</div>
		<div class="score">
			<div class="row">
...
<?php
	...
	$loadedQuestions = readQuestions("mod_3/questions.txt");
...
if (isset($_POST['submitquiz'])) {
	...
	$answerKey = readAnswerKey("mod_3/answerkey.txt");
		...
		echo '<div class="container">';
			echo '<div class="score">'; 
				echo '<div class="row">';
					...
					echo '<button id="return" type="button" class="btn btn-info">Return to Module 3</button>';
                    //echo '<button id="get_correct" type="button" class="btn btn-info">See Correct</button>'; 
				echo '</div>';
			echo '</div>'; 
		echo '</div>'; 
...
?>
	...
	<script>
		...
		$('#return').click(function(){
			window.location.replace("../user_account/modThree.html");
		})
	</script>
